...
namespace Pulumi.AzureWebapp
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AzureWebapp.version.txt");
    ...
    internal sealed class AzureWebappResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AzureWebappResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
